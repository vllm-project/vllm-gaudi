...
| `VLLM_MOE_GRAPH_BREAK`   | Inserts a graph break between attention and MLP in MoE decoder layers. Reduces `torch.compile` warmup recompilations at the cost of additional graph-break overhead at runtime. | `false`        |
