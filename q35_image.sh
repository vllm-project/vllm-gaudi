...
python test.py \
  ...
  --text-api generate \
  --max-model-len 16384 \
  --image-url "https://upload.wikimedia.org/wikipedia/commons/thumb/d/dd/Gfp-wisconsin-madison-the-nature-boardwalk.jpg/330px-Gfp-wisconsin-madison-the-nature-boardwalk.jpg" \
  --max-num-batched-tokens 4096 2>&1 | tee log_image.txt
