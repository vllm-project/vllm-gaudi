...
Vendored into vllm-gaudi so that Starcoder2 models keep using the native
vLLM implementation on HPU. Upstream vLLM migrated this architecture to the
Transformers modeling backend, which does not trace cleanly under HPU
warmup/bucketing. Registering this native implementation restores functional
and performance parity on Gaudi.
"""
