...
class HpuModelAdapter(torch.nn.Module):
    ...
    def forward(self, *args, **kwargs):
        ...
        kwargs['attn_metadata'] = self._update_metadata(kwargs['attn_metadata'], input_ids.size(0), input_ids.size(1),
...
class HPUModelRunner:
    ...
    def _prepare_prefill_inputs(self, num_prefills, num_decodes, num_scheduled_tokens: list[int]) -> PrefillInputData:
    ...
    def _prepare_decode_inputs(self, num_decodes, num_scheduled_tokens, scheduler_output=None) -> DecodeInputData:
    ...
    def execute_model(
        ...
        with self.profiler.record_event('internal', 'prepare_input_tensors'):
            prefill_data, decode_data = self._prepare_inputs(scheduler_output, num_prefills, num_decodes)
    ...
    def _execute_dummy_scenario(self, prompt_cfg, decode_cfg):
        ...
        if decode_cfg:
            ...
            if self.use_contiguous_pa:
                ...
                decode_seq_lengths = self._generate_seq_lengths(decode_bs, decode_blocks, self.block_size)
                block_id = 0
