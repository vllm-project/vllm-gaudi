...
class HPUModelRunner(HpuKVConnectorModelRunnerMixin):
    ...
    def apply_grammar_bitmask(
        ...
        sorted_bitmask = np.full(shape=(logits.shape[0], grammar_bitmask.shape[1]), fill_value=-1, dtype=grammar_bitmask.dtype)
        cumulative_index = 0
        ...
        xgr_cpu.apply_token_bitmask_inplace_cpu(logits_cpu, grammar_bitmask.to("cpu"), indices=out_indices if not skip_out_indices else None)
