...
class HPUModelRunner(KVConnectorModelRunnerMixin):
    ...
    def _add_dummy_request(self,
        ...
        block_ids = [[block_id] * (round_up(total_tokens_for_blocks, g.kv_cache_spec.block_size) // g.kv_cache_spec.block_size) for g in self.kv_cache_config.kv_cache_groups]
