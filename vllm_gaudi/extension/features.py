...
def get_user_flags():
    flags = [
        ...
        ExperimentalEnv('VLLM_PROMPT_BS_BUCKET_MIN', int),
        ExperimentalEnv('VLLM_PROMPT_BS_BUCKET_STEP', int),
        ExperimentalEnv('VLLM_PROMPT_BS_BUCKET_MAX', int),
        ExperimentalEnv('VLLM_PROMPT_QUERY_BUCKET_MIN', int),
        ExperimentalEnv('VLLM_PROMPT_QUERY_BUCKET_STEP', int),
        ExperimentalEnv('VLLM_PROMPT_QUERY_BUCKET_MAX', int),
        ExperimentalEnv('VLLM_PROMPT_SEQ_BUCKET_MIN', int),
        ExperimentalEnv('VLLM_PROMPT_SEQ_BUCKET_STEP', int),
        ExperimentalEnv('VLLM_PROMPT_SEQ_BUCKET_MAX', int),
        ExperimentalEnv('VLLM_PROMPT_CTX_BUCKET_MIN', int),
        ExperimentalEnv('VLLM_PROMPT_CTX_BUCKET_STEP', int),
        ExperimentalEnv('VLLM_PROMPT_CTX_BUCKET_MAX', int),
        ExperimentalEnv('VLLM_DECODE_BS_BUCKET_MIN', int),
        ExperimentalEnv('VLLM_DECODE_BS_BUCKET_STEP', int),
        ExperimentalEnv('VLLM_DECODE_BS_BUCKET_MAX', int),
        ExperimentalEnv('VLLM_DECODE_BLOCK_BUCKET_MIN', int),
        ExperimentalEnv('VLLM_DECODE_BLOCK_BUCKET_STEP', int),
        ExperimentalEnv('VLLM_DECODE_BLOCK_BUCKET_MAX', int),
        ExperimentalEnv('VLLM_DECODE_BLOCK_BUCKET_LIMIT', int),
        ExperimentalEnv('VLLM_BUCKETING_FROM_FILE', str),

        # Non-vllm flags that are also important to print
        ExperimentalEnv('EXPERIMENTAL_WEIGHT_SHARING', str),
...
def get_experimental_flags():
    flags = [
        ExperimentalEnv('VLLM_PT_PROFILE', str),
        ExperimentalEnv('VLLM_PROFILE_PROMPT', str),
        ExperimentalEnv('VLLM_PROFILE_DECODE', str),
        ExperimentalEnv('VLLM_PROFILE_STEPS', list_of(int)),
        ExperimentalEnv('VLLM_DEFRAG_THRESHOLD', int),
        ExperimentalEnv('VLLM_DEFRAG_WITH_GRAPHS', boolean),
        ExperimentalEnv('VLLM_DEBUG', list_of(str), check=for_all(choice('steps', 'defrag', 'fwd'))),
    ]
    return to_dict(flags)
