...
class HpuPlatform(Platform):
    ...
    def check_and_update_config(cls, vllm_config: VllmConfig) -> None:
        ...
        # For hybrid models, avoid changing block_size if already set
        cache_config = vllm_config.cache_config
        model_config = vllm_config.model_config
        is_hybrid = model_config is not None and model_config.is_hybrid
        if not cache_config.user_specified_block_size and (not is_hybrid or cache_config.block_size is None):
