...
run_basic_load_generate_test() {
    ...
    HABANA_VISIBLE_DEVICES=all VLLM_SKIP_WARMUP=true python -u "${VLLM_GAUDI_PREFIX}/tests/full_tests/generate.py" --model /mnt/weka/data/huggingface-models/facebook/opt-125m
...
run_tp2_load_generate_test() {
    ...
    HABANA_VISIBLE_DEVICES=all VLLM_SKIP_WARMUP=true python -u "${VLLM_GAUDI_PREFIX}/tests/full_tests/generate.py" --model /mnt/weka/data/huggingface-models/facebook/opt-125m --tensor-parallel-size 2
...
run_granite_inc_load_generate_test() {
    ...
    HABANA_VISIBLE_DEVICES=all VLLM_SKIP_WARMUP=true python -u "${VLLM_GAUDI_PREFIX}/tests/full_tests/generate.py" --model /mnt/weka/data/huggingface-models/ibm-granite/granite-3.3-2b-instruct --trust-remote-code --quantization inc --kv_cache_dtype fp8_inc
...
run_qwen3_blockfp8_dynamic_scaling_load_generate_test() {
    ...
    HABANA_VISIBLE_DEVICES=all VLLM_CONTIGUOUS_PA=False VLLM_SKIP_WARMUP=true python -u "${VLLM_GAUDI_PREFIX}/tests/full_tests/generate.py" --model /mnt/weka/data/huggingface-models/qwen/Qwen3-8B-FP8 --trust-remote-code
...
run_qwen3_compressed_tensor_dynamic_scaling_load_generate_test() {
    ...
    HABANA_VISIBLE_DEVICES=all VLLM_CONTIGUOUS_PA=False VLLM_SKIP_WARMUP=true python -u "${VLLM_GAUDI_PREFIX}/tests/full_tests/generate.py" --model /mnt/weka/data/pytorch/RedHatAI/Qwen3-8B-FP8-dynamic --trust-remote-code
...
run_qwen3_moe_compressed_tensor_dynamic_scaling_load_generate_test() {
    ...
    HABANA_VISIBLE_DEVICES=all VLLM_CONTIGUOUS_PA=False VLLM_SKIP_WARMUP=true python -u "${VLLM_GAUDI_PREFIX}/tests/full_tests/generate.py" --model /mnt/weka/data/huggingface-models/qwen/Qwen3-30B-A3B-Instruct-2507-FP8 --trust-remote-code --max-model-len 131072
...
run_qwen3_moe_compressed_tensor_static_scaling_load_generate_test() {
    ...
    HABANA_VISIBLE_DEVICES=all VLLM_CONTIGUOUS_PA=False VLLM_SKIP_WARMUP=true python -u "${VLLM_GAUDI_PREFIX}/tests/full_tests/generate.py" --model /mnt/weka/data/huggingface-models/Intel/Qwen3-30B-A3B-FP8-Static-Test-Only --trust-remote-code --no-enforce-eager --enable-expert-parallel
...
run_llama3_per_tensor_scaling_load_generate_test() {
    ...
    HABANA_VISIBLE_DEVICES=all VLLM_CONTIGUOUS_PA=False VLLM_SKIP_WARMUP=true python -u "${VLLM_GAUDI_PREFIX}/tests/full_tests/generate.py" --model /mnt/weka/data/pytorch/RedHatAI/Meta-Llama-3-8B-Instruct-FP8 --trust-remote-code
...
run_llama3_modelopt_per_tensor_scaling_load_generate_test() {
    ...
    HABANA_VISIBLE_DEVICES=all VLLM_CONTIGUOUS_PA=False VLLM_SKIP_WARMUP=true python -u "${VLLM_GAUDI_PREFIX}/tests/full_tests/generate.py" --model /mnt/weka/data/huggingface-models/nvidia/Llama-3.1-8B-Instruct-FP8 --trust-remote-code --kv_cache_dtype fp8_inc
...
run_awq_load_generate_test() {
    ...
    HABANA_VISIBLE_DEVICES=all VLLM_SKIP_WARMUP=true python -u "${VLLM_GAUDI_PREFIX}/tests/full_tests/generate.py" --model /mnt/weka/data/huggingface-models/TheBloke/Llama-2-7B-Chat-AWQ --dtype bfloat16 --quantization awq_hpu
...
run_gptq_load_generate_test() {
    ...
    HABANA_VISIBLE_DEVICES=all VLLM_SKIP_WARMUP=true python -u "${VLLM_GAUDI_PREFIX}/tests/full_tests/generate.py" --model /mnt/weka/data/huggingface-models/TheBloke/Llama-2-7B-Chat-GPTQ --dtype bfloat16 --quantization gptq_hpu
...
run_compressed_w4a16_channelwise_load_generate_test() {
    ...
    HABANA_VISIBLE_DEVICES=all VLLM_SKIP_WARMUP=true python -u "${VLLM_GAUDI_PREFIX}/tests/full_tests/generate.py" --model /mnt/weka/data/huggingface-models/nm-testing/tinyllama-oneshot-w4a16-channel-v2 --dtype bfloat16
...
run_compressed_w4a16_moe_gidx_load_generate_test() {
    ...
    HABANA_VISIBLE_DEVICES=all VLLM_SKIP_WARMUP=true python -u "${VLLM_GAUDI_PREFIX}/tests/full_tests/generate.py" --model /mnt/weka/data/huggingface-models/nm-testing/test-w4a16-mixtral-actorder-group --dtype bfloat16
...
run_embedding_model_test() {
   ...
   HABANA_VISIBLE_DEVICES=all VLLM_CONTIGUOUS_PA=False VLLM_SKIP_WARMUP=false python -u "${VLLM_GAUDI_PREFIX}/tests/full_tests/pooling.py" --model /mnt/weka/data/huggingface-models/intfloat/e5-mistral-7b-instruct --trust-remote-code
