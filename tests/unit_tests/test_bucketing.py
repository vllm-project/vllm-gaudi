...
def test_generate_prompt_buckets():
    ...
    buckets, omitted_buckets = linear.generate_prompt_buckets(bs_bucket_config, seq_bucket_config, block_size,
                                                              prefix_caching, max_num_batched_tokens)
...
def test_generate_decode_buckets():
    ...
    block_size = 128
    buckets = linear.generate_decode_buckets(bs_bucket_config, blocks_bucket_config, max_blocks, max_model_len,
                                             block_size)
