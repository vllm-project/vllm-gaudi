...
# SERVER CONFIG
# =========================
# container=pt_vllm_Qwen_Qwen3.6-35B-A3B_3_5
...
cat > /tmp/tool_probe_8270.json <<'JSON'
{
  "model": "Qwen/Qwen3.6-35B-A3B",
  "messages": [
    {
...
curl -sS http://localhost:8270/v1/chat/completions \
  -H "Content-Type: application/json" \
  --data @/tmp/tool_probe_8270.json
