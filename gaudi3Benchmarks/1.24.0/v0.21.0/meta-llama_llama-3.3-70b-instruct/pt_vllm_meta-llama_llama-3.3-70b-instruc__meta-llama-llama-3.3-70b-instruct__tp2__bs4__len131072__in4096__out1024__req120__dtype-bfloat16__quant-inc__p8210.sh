...
# SERVER CONFIG
# =========================
# container=pt_vllm_meta-llama_Llama-3.3-70B-Instruct_5_7
# model=meta-llama/Llama-3.3-70B-Instruct
# tensor_parallel_size=2
# batch_size=4
# max_model_len=131072
# dtype=bfloat16
# quant_config=/software/ae/fmwork/inc/1.24.0/llama-3.3-70b-instruct-2x/maxabs_quant_g3.json
# input_len=4096
# output_len=1024
# num_prompts=120
...
export QUANT_CONFIG=/software/ae/fmwork/inc/1.24.0/llama-3.3-70b-instruct-2x/maxabs_quant_g3.json
...
cat > /tmp/tool_probe_8210.json <<'JSON'
{
  "model": "meta-llama/Llama-3.3-70B-Instruct",
  "messages": [
    {
...
curl -sS http://localhost:8210/v1/chat/completions \
  -H "Content-Type: application/json" \
  --data @/tmp/tool_probe_8210.json
