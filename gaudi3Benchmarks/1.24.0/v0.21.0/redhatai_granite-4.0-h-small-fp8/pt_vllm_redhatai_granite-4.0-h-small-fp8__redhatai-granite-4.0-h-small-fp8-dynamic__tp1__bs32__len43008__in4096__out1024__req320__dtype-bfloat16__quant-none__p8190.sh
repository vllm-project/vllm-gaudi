...
# SERVER CONFIG
# =========================
# container=pt_vllm_RedHatAI_granite-4.0-h-small-FP8-dynamic_0
...
VLLM_BUCKET_FILENAME=/software/ae/fmwork/vllm_buckets_43008.txt \
...
cat > /tmp/tool_probe_8190.json <<'JSON'
{
  "model": "RedHatAI/granite-4.0-h-small-FP8-dynamic",
  "messages": [
    {
...
curl -sS http://localhost:8190/v1/chat/completions \
  -H "Content-Type: application/json" \
  --data @/tmp/tool_probe_8190.json
