# Qwen/Qwen3-VL-32B-Instruct-fp8 for interactive with batch size 16 with SLA TTFT <2s 
...
python3 -m vllm.entrypoints.openai.api_server \
  ...
  --trust-remote-code 2>&1 | tee Qwen3-VL-32B-Instruct_fp8_server.txt
...
vllm bench serve \
  ...
  --trust-remote-code 2>&1 | tee Qwen3-VL-32B-Instruct_benchmark-fp8.txt
