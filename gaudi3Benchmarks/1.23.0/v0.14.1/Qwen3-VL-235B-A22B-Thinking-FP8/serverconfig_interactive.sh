# Qwen/Qwen3-VL-235B-A22B-Thinking-FP8 for interactive with batch size 16 with SLA TTFT <2s 
...
vllm serve \
  ...
  --trust-remote-code 2>&1 | tee Qwen3-VL-235B-A22B-Thinking-FP8_server.txt
...
vllm bench serve \
  ...
  --trust-remote-code 2>&1 | tee Qwen3-VL-235B-A22B-Thinking-FP8_benchmark.txt
