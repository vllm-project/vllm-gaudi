# Qwen/Qwen3-VL-235B-A22B-Thinking for interactive with batch size 16 with SLA TTFT <2s 
...
python3 -m vllm.entrypoints.openai.api_server \
  ...
  --trust-remote-code 2>&1 | tee Qwen3-VL-235B-A22B-Thinking_server.txt

#benchamark command 
vllm bench serve \
  --backend openai-chat \
  --model Qwen/Qwen3-VL-235B-A22B-Thinking \
  --tokenizer Qwen/Qwen3-VL-235B-A22B-Thinking \
  ...
  --trust-remote-code 2>&1 | tee Qwen3-VL-235B-A22B-Thinking_benchmark.txt
