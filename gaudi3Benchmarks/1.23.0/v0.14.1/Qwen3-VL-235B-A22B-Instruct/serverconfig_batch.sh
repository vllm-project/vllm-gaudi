# Qwen/Qwen3-VL-235B-A22B-Instruct for batch mode with batch size 16 for max perf 
...
python3 -m vllm.entrypoints.openai.api_server \
  ...
  --trust-remote-code 2>&1 | tee Qwen3-VL-235B-A22B-Instruct_server.txt
...
vllm bench serve \
  ...
  --trust-remote-code 2>&1 | tee Qwen3-VL-235B-A22B-Instruct_benchmark.txt
