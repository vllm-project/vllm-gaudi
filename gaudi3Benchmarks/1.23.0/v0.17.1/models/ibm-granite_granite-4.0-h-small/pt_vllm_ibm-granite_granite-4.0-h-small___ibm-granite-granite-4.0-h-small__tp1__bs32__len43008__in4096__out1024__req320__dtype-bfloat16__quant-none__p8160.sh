...
# SERVER CONFIG
# =========================
# container=pt_vllm_ibm-granite_granite-4.0-h-small_7
...
VLLM_BUCKET_FILENAME=/software/ae/fmwork/vllm_buckets.txt \
...
cat > /tmp/tool_probe_8160.json <<'JSON'
{
  "model": "ibm-granite/granite-4.0-h-small",
  "messages": [
    {
...
curl -sS http://localhost:8160/v1/chat/completions \
  -H "Content-Type: application/json" \
  --data @/tmp/tool_probe_8160.json
