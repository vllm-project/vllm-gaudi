#RedHatAI/Llama-3.1-8B-Instruct with guidellm

#vllm serve command 

export QUANT_CONFIG=/root/rh-llama-3.1-8b-instruct/maxabs_quant_g3.json
...
python3 -m vllm.entrypoints.openai.api_server \
  ...
  --trust-remote-code \
  > /tmp/pt_vllm_RedHatAI_Llama-3.1-8B-Instruct_4_8120.log
...
guidellm benchmark \
  ...
  | tee benchmark_core_RedHatAI_Llama-3.1-8B-Instruct-input_len-1024-output_len-1024-batch_size-128-device-1-port-8120-build_id-4.log
