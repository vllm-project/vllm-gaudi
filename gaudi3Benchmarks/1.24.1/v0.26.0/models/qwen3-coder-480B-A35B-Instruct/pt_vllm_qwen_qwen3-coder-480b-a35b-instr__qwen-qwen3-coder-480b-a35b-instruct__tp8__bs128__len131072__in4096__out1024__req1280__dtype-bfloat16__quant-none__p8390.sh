...
# SERVER CONFIG
# =========================
# container=pt_vllm_Qwen_Qwen3-Coder-480B-A35B-Instruct_0_1_2_3_4_5_6_7
...
cat > /tmp/tool_probe_8390.json <<'JSON'
{
  "model": "Qwen/Qwen3-Coder-480B-A35B-Instruct",
  "messages": [
    {
...
curl -sS http://localhost:8390/v1/chat/completions \
  -H "Content-Type: application/json" \
  --data @/tmp/tool_probe_8390.json
