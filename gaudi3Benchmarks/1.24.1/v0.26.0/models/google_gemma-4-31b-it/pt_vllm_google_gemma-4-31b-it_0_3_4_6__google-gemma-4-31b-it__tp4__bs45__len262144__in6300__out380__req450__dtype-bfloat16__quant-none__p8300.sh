...
# SERVER CONFIG
# =========================
# container=pt_vllm_google_gemma-4-31B-it_0_3_4_6
...
cat > /tmp/tool_probe_8300.json <<'JSON'
{
  "model": "google/gemma-4-31B-it",
  "messages": [
    {
...
curl -sS http://localhost:8300/v1/chat/completions \
  -H "Content-Type: application/json" \
  --data @/tmp/tool_probe_8300.json
