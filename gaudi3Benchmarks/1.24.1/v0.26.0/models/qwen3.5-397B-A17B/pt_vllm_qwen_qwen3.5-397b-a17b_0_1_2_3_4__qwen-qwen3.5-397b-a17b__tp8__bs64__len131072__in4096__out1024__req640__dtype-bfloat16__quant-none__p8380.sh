...
# SERVER CONFIG
# =========================
# container=pt_vllm_Qwen_Qwen3.5-397B-A17B_0_1_2_3_4_5_6_7
...
cat > /tmp/tool_probe_8380.json <<'JSON'
{
  "model": "Qwen/Qwen3.5-397B-A17B",
  "messages": [
    {
...
curl -sS http://localhost:8380/v1/chat/completions \
  -H "Content-Type: application/json" \
  --data @/tmp/tool_probe_8380.json
