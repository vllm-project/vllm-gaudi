...
# SERVER CONFIG
# =========================
# container=pt_vllm_Qwen_Qwen3-VL-235B-A22B-Thinking-FP8_0_3_4_6
...
VLLM_MOE_CHUNK=128,512 \
VLLM_MOE_TOKEN_BOUNDARY=128,99999 \
vllm serve \
    --model=Qwen/Qwen3-VL-235B-A22B-Thinking-FP8 \
    --port 8250 \
    --max-num-seqs=128 \
...
cat > /tmp/tool_probe_8250.json <<'JSON'
{
  "model": "Qwen/Qwen3-VL-235B-A22B-Thinking-FP8",
  "messages": [
    {
...
curl -sS http://localhost:8250/v1/chat/completions \
  -H "Content-Type: application/json" \
  --data @/tmp/tool_probe_8250.json
...
PYTHONUNBUFFERED=1 vllm bench serve \
    ...
    --backend openai-chat \
    --tokenizer Qwen/Qwen3-VL-235B-A22B-Thinking-FP8 \
