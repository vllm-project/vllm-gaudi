...
cat > /tmp/tool_probe_8360.json <<'JSON'
{
  "model": "meta-llama/Llama-4-Maverick-17B-128E-Instruct",
  "messages": [
    {
...
curl -sS http://localhost:8360/v1/chat/completions \
  -H "Content-Type: application/json" \
  --data @/tmp/tool_probe_8360.json

###curl with decoding_method
cat > /tmp/hs_ticket_repro_8360.json <<'JSON'
{
  "model": "meta-llama/Llama-4-Maverick-17B-128E-Instruct",
...
JSON
curl -sS http://localhost:8360/v1/completions   -H "Content-Type: application/json"   --data @/tmp/hs_ticket_repro_8360.json
