...
# dtype=bfloat16
# quant_config=/software/ae/fmwork/inc/1.24.0/llama-4-maverick-17b-128e-instruct/maxabs_quant_g3.json
# input_len=4096
# output_len=1024
# num_prompts=630
...
export QUANT_CONFIG=/software/ae/fmwork/inc/1.24.0/llama-4-maverick-17b-128e-instruct/maxabs_quant_g3.json
...
cat > /tmp/tool_probe_8350.json <<'JSON'
{
  "model": "meta-llama/Llama-4-Maverick-17B-128E-Instruct",
  "messages": [
    {
...
curl -sS http://localhost:8350/v1/chat/completions \
  -H "Content-Type: application/json" \
  --data @/tmp/tool_probe_8350.json

###curl with decoding_method
cat > /tmp/hs_ticket_repro_8350.json <<'JSON'
{
  "model": "meta-llama/Llama-4-Maverick-17B-128E-Instruct",
...
JSON
curl -sS http://localhost:8350/v1/completions   -H "Content-Type: application/json"   --data @/tmp/hs_ticket_repro_8350.json
