...
# SERVER CONFIG
# =========================
# container=pt_vllm_Qwen_Qwen3-Coder-Next_2_5
...
cat > /tmp/tool_probe_8410.json <<'JSON'
{
  "model": "Qwen/Qwen3-Coder-Next",
  "messages": [
    {
...
curl -sS http://localhost:8410/v1/chat/completions \
  -H "Content-Type: application/json" \
  --data @/tmp/tool_probe_8410.json
