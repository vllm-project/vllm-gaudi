...
# SERVER CONFIG
# =========================
# container=pt_vllm_Qwen_Qwen3-Coder-Next_1_7
...
cat > /tmp/tool_probe_8420.json <<'JSON'
{
  "model": "Qwen/Qwen3-Coder-Next",
  "messages": [
    {
...
curl -sS http://localhost:8420/v1/chat/completions \
  -H "Content-Type: application/json" \
  --data @/tmp/tool_probe_8420.json
