...
# SERVER CONFIG
# =========================
# container=pt_vllm_ibm-granite_granite-4.0-h-small_2
...
cat > /tmp/tool_probe_8180.json <<'JSON'
{
  "model": "ibm-granite/granite-4.0-h-small",
  "messages": [
    {
...
curl -sS http://localhost:8180/v1/chat/completions \
  -H "Content-Type: application/json" \
  --data @/tmp/tool_probe_8180.json
